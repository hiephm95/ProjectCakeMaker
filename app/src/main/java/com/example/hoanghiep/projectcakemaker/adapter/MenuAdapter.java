...
public class MenuAdapter extends BaseAdapter {
    ...
    class ViewHolder {
        ...
        public ViewHolder(View container) {
            tvMenu = (TextView) container.findViewById(R.id.tvTitle);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (screen.is_selected) {
            convertView.setBackgroundColor(parent.getContext().getResources().getColor(R.color.pink));
            ...
            //vh.tvMenu.setTextColor(parent.getContext().getResources().getColor(R.color.gray));
        }
